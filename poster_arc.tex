...
\begin{multicols}{2}
    ...
    \begin{multicols}{2}
        \begin{center}
            ...
            \captionof{figure}{Champs de température ($\mathrm{Re}=20$, eau à 20°C, $\mathrm{Bi}=0.1$)}
            \label{fig:thermal}
        \end{center}
        \columnbreak
        \begin{center}
            \includegraphics[width=0.98\columnwidth]{01-established_wave_T_Bi100}
            \captionof{figure}{Champs de température ($\mathrm{Re}=20$, eau à 20°C, $\mathrm{Bi}=100$)}
    ...
    \begin{multicols}{2}
        ...
        \begin{center}
            ...
            \captionof{figure}{Plaque verticale avec forçage (3\,Hz à 18\,Hz) bruité en entrée ($\mathrm{Re}=20$, eau à 20°C)}
        ...
        \begin{center}
            ...
            \captionof{figure}{Intensification de transfert sur une plaque verticale de 60 cm avec forçage (1\,Hz à 48\,Hz) bruité en entrée ($\mathrm{Re}=20$, eau à 20°C, $\mathrm{Bi}=0.1$, Peclet forcé à 525)}
